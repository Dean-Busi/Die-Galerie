...
namespace Backend.Controllers
{
    ...
    public class GemaeldeController : ControllerBase
    {
        ...
        {
            var gemaelder = await _context.Gemaelder.Include(c => c.Kommentare).Include(b => b.Bewertungen).ToListAsync();
        ...
        {
            var gemaelde = await _context.Gemaelder.Include(c => c.Kommentare).Include(b => b.Bewertungen).ToListAsync();
